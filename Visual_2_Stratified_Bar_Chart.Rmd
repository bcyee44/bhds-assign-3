---
title: "Visual_2_Stratified_Bar_Chart"
author: "Veronica Leary"
date: "`r Sys.Date()`"
output: pdf_document
---
...
#Use ggplot() with pipeline and dplyr set as groups 1 and 2 and stratified by two points in time-at basline and six months (x-axis) and asssessed by the number of text messages (y-axis) with text messages ranging from 0 to 1500
data %>%
  group_by(Group, Time) %>%
